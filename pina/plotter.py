...
class Plotter:
    ...
    def plot_same_training_test_data(self, pinn, components=None, fixed_variables={}, method='contourf',
        ...
        mdic = {"predicted_output_AD_3":predicted_output_array, "pts_array_AD_3":pts_array}
    ...
    def plot(self, pinn, components=None, fixed_variables={}, method='contourf',
        ...
        mdic = {"predicted_output_AD_0":predicted_output_array, "pts_array_AD_0":pts_array}
        savemat("Burgers_Dis_AD_0.mat", mdic)
    ...
    def plot_loss(self, pinn, label=None, log_scale=True):
        ...
        mdic_loss = {"epochs_AD_3":epochs, "loss_AD_3":loss}
        savemat("burgers_loss_AD_3.mat", mdic_loss)
